...
class PrintService {
  ...
  static const String _address        = 'Gap Chowk, Near Muslim Road, Gujranwala';
  static const String _phone          = 'Ph: 055-4226968';
  ...
  static Future<void> printReceipt({
    ...
    try {
      ...
      // 80-mm thermal roll width (~226 pt usable) with tight margins
          ...
          build: (pw.Context ctx) {
            return pw.Column(
              ...
              children: [
                ...
                pw.Text(_address,  textAlign: pw.TextAlign.center, style: const pw.TextStyle(fontSize: 9)),
                pw.Text(_phone,    textAlign: pw.TextAlign.center, style: const pw.TextStyle(fontSize: 9)),
                pw.SizedBox(height: 2),
                ...
                pw.Table(
                  columnWidths: const {
                    ...
                    3: pw.FlexColumnWidth(1.5), // GST 18%
                  ...
                  children: [
                    ...
                    pw.TableRow(
                      children: [
                        ...
                        _tableCell('GST\n18%', bold: true, align: pw.TextAlign.right),
                    ...
                    ...cart.map((item) {
                      ...
                      final gstAmt    = rate * _gstRate * item.quantity;
                ...
                if (fbrInvoiceNumber.isNotEmpty) ...[
                  pw.Text('FBR', style: pw.TextStyle(fontSize: 22, fontWeight: pw.FontWeight.bold)),
                  pw.SizedBox(height: 4),
                  pw.Text('FBR Invoice Number', style: pw.TextStyle(fontSize: 9, fontWeight: pw.FontWeight.bold)),
